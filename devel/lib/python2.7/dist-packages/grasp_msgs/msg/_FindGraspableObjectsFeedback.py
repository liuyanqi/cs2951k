...
"""autogenerated by genpy from grasp_msgs/FindGraspableObjectsFeedback.msg. Do not edit."""
import sys
...
class FindGraspableObjectsFeedback(genpy.Message):
  ...
  _type = "grasp_msgs/FindGraspableObjectsFeedback"
...
float64 z"""
  __slots__ = ['object']
  _slot_types = ['grasp_msgs/GraspableObject']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.object is None:
        self.object = grasp_msgs.msg.GraspableObject()
    else:
      self.object = grasp_msgs.msg.GraspableObject()
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_struct_3I.pack(_x.object.object.header.seq, _x.object.object.header.stamp.secs, _x.object.object.header.stamp.nsecs))
      ...
      for val1 in self.object.object.properties:
        ...
        if python3:
          ...
          buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_3I.pack(_x.object.object.point_cluster.header.seq, _x.object.object.point_cluster.header.stamp.secs, _x.object.object.point_cluster.header.stamp.nsecs))
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_2I.pack(_x.object.object.point_cluster.height, _x.object.object.point_cluster.width))
      ...
      _x = self
      buff.write(_struct_B2I.pack(_x.object.object.point_cluster.is_bigendian, _x.object.object.point_cluster.point_step, _x.object.object.point_cluster.row_step))
      ...
      if type(_x) in [list, tuple]:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_struct_B.pack(self.object.object.point_cluster.is_dense))
      ...
      for val1 in self.object.object.mesh_poses:
        ...
        _x = _v4
        buff.write(_struct_4d.pack(_x.x, _x.y, _x.z, _x.w))
      buff.write(_struct_4d.pack(*self.object.object.surface.coef))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.object.object.header.seq, _x.object.object.header.stamp.secs, _x.object.object.header.stamp.nsecs,) = _struct_3I.unpack(str[start:end])
      start = end
      end += 4
      ...
      (_x.object.object.point_cluster.header.seq, _x.object.object.point_cluster.header.stamp.secs, _x.object.object.point_cluster.header.stamp.nsecs,) = _struct_3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (_x.object.object.point_cluster.height, _x.object.object.point_cluster.width,) = _struct_2I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      ...
      (_x.object.object.point_cluster.is_bigendian, _x.object.object.point_cluster.point_step, _x.object.object.point_cluster.row_step,) = _struct_B2I.unpack(str[start:end])
      ...
      (self.object.object.point_cluster.is_dense,) = _struct_B.unpack(str[start:end])
      ...
      self.object.object.surface.coef = _struct_4d.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.object.grasps = []
