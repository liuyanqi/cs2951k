...
"""autogenerated by genpy from grasp_msgs/GraspPlanningActionFeedback.msg. Do not edit."""
import sys
...
class GraspPlanningActionFeedback(genpy.Message):
  ...
  _type = "grasp_msgs/GraspPlanningActionFeedback"
...
float64 z"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','grasp_msgs/GraspPlanningFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.feedback is None:
        self.feedback = grasp_msgs.msg.GraspPlanningFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = grasp_msgs.msg.GraspPlanningFeedback()
