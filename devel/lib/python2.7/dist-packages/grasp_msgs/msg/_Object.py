...
"""autogenerated by genpy from grasp_msgs/Object.msg. Do not edit."""
import sys
...
"""
  ...
  _slot_types = ['std_msgs/Header','string','string','grasp_msgs/ObjectProperty[]','sensor_msgs/PointCloud2','shape_msgs/SolidPrimitive[]','geometry_msgs/Pose[]','shape_msgs/Mesh[]','geometry_msgs/Pose[]','shape_msgs/Plane']
    ...
    try:
      ...
      for val1 in self.properties:
        ...
        if python3:
          ...
          buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_3I.pack(_x.point_cluster.header.seq, _x.point_cluster.header.stamp.secs, _x.point_cluster.header.stamp.nsecs))
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_2I.pack(_x.point_cluster.height, _x.point_cluster.width))
      ...
      _x = self
      buff.write(_struct_B2I.pack(_x.point_cluster.is_bigendian, _x.point_cluster.point_step, _x.point_cluster.row_step))
      ...
      if type(_x) in [list, tuple]:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_struct_B.pack(self.point_cluster.is_dense))
      ...
      for val1 in self.mesh_poses:
        ...
        _x = _v4
        buff.write(_struct_4d.pack(_x.x, _x.y, _x.z, _x.w))
      buff.write(_struct_4d.pack(*self.surface.coef))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.point_cluster.header.seq, _x.point_cluster.header.stamp.secs, _x.point_cluster.header.stamp.nsecs,) = _struct_3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (_x.point_cluster.height, _x.point_cluster.width,) = _struct_2I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      ...
      (_x.point_cluster.is_bigendian, _x.point_cluster.point_step, _x.point_cluster.row_step,) = _struct_B2I.unpack(str[start:end])
      ...
      (self.point_cluster.is_dense,) = _struct_B.unpack(str[start:end])
      ...
      self.surface.coef = _struct_4d.unpack(str[start:end])
      return self
