...
(cl:defclass <Object> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (properties
    :reader properties
    :initarg :properties
    :type (cl:vector grasp_msgs-msg:ObjectProperty)
   :initform (cl:make-array 0 :element-type 'grasp_msgs-msg:ObjectProperty :initial-element (cl:make-instance 'grasp_msgs-msg:ObjectProperty)))
   (point_cluster
...
(cl:defmethod cl:initialize-instance :after ((m <Object>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Object)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name grasp_msgs-msg:<Object> is deprecated: use grasp_msgs-msg:Object instead.")))
...
(cl:defmethod support_surface-val ((m <Object>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader grasp_msgs-msg:support_surface-val is deprecated.  Use grasp_msgs-msg:support_surface instead.")
  (support_surface m))

(cl:ensure-generic-function 'properties-val :lambda-list '(m))
(cl:defmethod properties-val ((m <Object>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader grasp_msgs-msg:properties-val is deprecated.  Use grasp_msgs-msg:properties instead.")
  (properties m))

(cl:ensure-generic-function 'point_cluster-val :lambda-list '(m))
(cl:defmethod point_cluster-val ((m <Object>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader grasp_msgs-msg:point_cluster-val is deprecated.  Use grasp_msgs-msg:point_cluster instead.")
  (point_cluster m))

(cl:ensure-generic-function 'primitives-val :lambda-list '(m))
(cl:defmethod primitives-val ((m <Object>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader grasp_msgs-msg:primitives-val is deprecated.  Use grasp_msgs-msg:primitives instead.")
  (primitives m))

(cl:ensure-generic-function 'primitive_poses-val :lambda-list '(m))
(cl:defmethod primitive_poses-val ((m <Object>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader grasp_msgs-msg:primitive_poses-val is deprecated.  Use grasp_msgs-msg:primitive_poses instead.")
  (primitive_poses m))

(cl:ensure-generic-function 'meshes-val :lambda-list '(m))
(cl:defmethod meshes-val ((m <Object>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader grasp_msgs-msg:meshes-val is deprecated.  Use grasp_msgs-msg:meshes instead.")
  (meshes m))

(cl:ensure-generic-function 'mesh_poses-val :lambda-list '(m))
(cl:defmethod mesh_poses-val ((m <Object>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader grasp_msgs-msg:mesh_poses-val is deprecated.  Use grasp_msgs-msg:mesh_poses instead.")
  (mesh_poses m))

(cl:ensure-generic-function 'surface-val :lambda-list '(m))
(cl:defmethod surface-val ((m <Object>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader grasp_msgs-msg:surface-val is deprecated.  Use grasp_msgs-msg:surface instead.")
  (surface m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <Object>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'properties)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'grasp_msgs-msg:ObjectProperty))
