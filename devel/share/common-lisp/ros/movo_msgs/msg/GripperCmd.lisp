...
(cl:defmethod cl:initialize-instance :after ((m <GripperCmd>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GripperCmd)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name movo_msgs-msg:<GripperCmd> is deprecated: use movo_msgs-msg:GripperCmd instead.")))

(cl:ensure-generic-function 'emergency_release-val :lambda-list '(m))
(cl:defmethod emergency_release-val ((m <GripperCmd>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader movo_msgs-msg:emergency_release-val is deprecated.  Use movo_msgs-msg:emergency_release instead.")
  (emergency_release m))

(cl:ensure-generic-function 'emergency_release_dir-val :lambda-list '(m))
(cl:defmethod emergency_release_dir-val ((m <GripperCmd>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader movo_msgs-msg:emergency_release_dir-val is deprecated.  Use movo_msgs-msg:emergency_release_dir instead.")
  (emergency_release_dir m))

(cl:ensure-generic-function 'stop-val :lambda-list '(m))
(cl:defmethod stop-val ((m <GripperCmd>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader movo_msgs-msg:stop-val is deprecated.  Use movo_msgs-msg:stop instead.")
  (stop m))
...
(cl:defmethod speed-val ((m <GripperCmd>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader movo_msgs-msg:speed-val is deprecated.  Use movo_msgs-msg:speed instead.")
  (speed m))

(cl:ensure-generic-function 'force-val :lambda-list '(m))
(cl:defmethod force-val ((m <GripperCmd>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader movo_msgs-msg:force-val is deprecated.  Use movo_msgs-msg:force instead.")
  (force m))
