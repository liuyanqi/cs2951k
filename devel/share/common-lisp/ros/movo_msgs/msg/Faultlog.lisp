...
(cl:defmethod cl:initialize-instance :after ((m <Faultlog>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Faultlog)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name movo_msgs-msg:<Faultlog> is deprecated: use movo_msgs-msg:Faultlog instead.")))

(cl:ensure-generic-function 'data-val :lambda-list '(m))
(cl:defmethod data-val ((m <Faultlog>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader movo_msgs-msg:data-val is deprecated.  Use movo_msgs-msg:data instead.")
  (data m))
